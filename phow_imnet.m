...
conf.calDir = fullfile(getPath(source),'images');
conf.dataDir = fullfile(getPath(source),'processed');
...
conf.vocabPath = fullfile(getPath,'processed','kaggle_phow','baseline-vocab.mat');
